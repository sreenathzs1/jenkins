def nexus(COMPONENT) {
    ...
    command = "curl -f -v -u admin:admin123 --upload-file /home/ubuntu/workspace/CI-Pipelines/frontend-ci/${FILENAME} http://172.31.11.166:8081/repository/${COMPONENT}/${FILENAME}"
